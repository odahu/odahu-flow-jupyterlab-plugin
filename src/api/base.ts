  ...
  let setting = ServerConnection.makeSettings({
    init: {
      headers:
        credentials != null
          ? {
              'X-Odahuflow-Cloud-Endpoint': credentials.cluster,
              'X-Odahuflow-Cloud-Token': credentials.authString
            }
          : {}
    }
  });
...
/**
 * Root API for all Odahuflow endpoints
 */
export const odahuflowApiRootURL = '/odahuflow/api';
