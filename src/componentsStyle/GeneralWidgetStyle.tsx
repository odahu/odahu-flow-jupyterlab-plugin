...
export const authIcon = style({
  backgroundImage: 'var(--jp-icon-odahuflow-lock)',
  width: 80,
  height: 80,
  backgroundSize: 80,
...
export const cloudModeTabStyle = style({
  backgroundImage: 'var(--jp-icon-odahuflow-cloud)'
});
...
export const stripperLine = style({
  ...
  animation: 'odahuflow-stripe-animation 10s linear infinite',
  textAlign: 'center',
  color: '#fff',
...
export const cloudLogWidgetIcon = style({
  ...
  '-webkit-animation':
    'odahuflow-loading-rotate-center 1s linear infinite both',
  animation: 'odahuflow-loading-rotate-center 1s linear infinite both',
  minWidth: 16,
  minHeight: 16,
  backgroundSize: 16,
