...
export const PLUGIN_CREDENTIALS_STORE_CLUSTER = `odahuflow.cluster:credentials-cluster`;
export const PLUGIN_CREDENTIALS_STORE_TOKEN = `odahuflow.cluster:credentials-token`;
export const ODAHUFLOW_OAUTH_TOKEN_COOKIE_NAME = `_odahuflow_oauth_token`;
